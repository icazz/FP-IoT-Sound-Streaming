...
// // --- Kredensial Wi-Fi ---
// const char* ssid = "samara";
// const char* password = "deija035";

// // --- IP Receiver ---
// // IPAddress remoteIP(192, 168, 43, 137);
// IPAddress remoteIP(192, 168, 43, 137);
...
//     // Ambil ambang batas 100. Jika rata-rata di atas 100, ada suara signifikan.
//     if (avg_sample_value > 100) { 
//         Serial.print("🔊 Audio OK! Avg Value: ");
//         Serial.print(avg_sample_value);
//     } else {
//         // Hanya cetak pesan diam setiap 100 kali loop agar Serial Monitor tidak penuh
...
//     if (send_status) {
//         // Serial.println(" | UDP Sent OK."); // Terlalu banyak cetak, nonaktifkan
//     } else {
//         Serial.println(" | ❌ ERROR: Failed to send UDP packet! (Check Receiver IP)");
//     }
//   } else {
//     // Jika i2s_read mengembalikan 0 bytes (koneksi mic gagal)
...
IPAddress remoteIP(192, 168, 1, 12); 
const unsigned int remotePort = 4210;
WiFiUDP Udp;
